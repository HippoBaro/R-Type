...
RTypeGameContext::RTypeGameContext() : _pool() {
    ...
    ManagedExternalInstance<Entity> monster(ExternalClassFactoryLoader::Instance->GetInstanceOf<Entity>("libDrawableDummyMonster.so", { timer }, "createDrawable", "destroyDrawable"));
