...
MenuMusicVolume::MenuMusicVolume(std::shared_ptr<RType::EventManager> &eventManager) : _eventListener(eventManager) {
...
void MenuMusicVolume::specialDrawing(sf::RenderTexture &context, sf::Text &text) {
