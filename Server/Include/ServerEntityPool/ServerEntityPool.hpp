...
public :
    void BroadcastEntities(int, const std::shared_ptr<RType::EventManager> &eventManager, std::vector<std::shared_ptr<PlayerRef>> &);
    void BroadcastEntitiesThatStillExist(int, const std::shared_ptr<RType::EventManager> &eventManager, const std::vector<std::shared_ptr<PlayerRef>> &);
};
