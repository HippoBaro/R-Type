//
// Created by hippolyteb on 12/8/16.
//

#ifndef RTYPE_JSON_HPP
#define RTYPE_JSON_HPP
...
#define CLANG_VERSION (__clang_major__ * 10000 + __clang_minor__ * 100 + __clang_patchlevel__)
        ...
        #error "unsupported Clang version - see https://github.com/RType/json#supported-compilers"
    #endif
#elif defined(__GNUC__)
#define GCC_VERSION (__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__)
#if GCC_VERSION < 40900
#error "unsupported GCC version - see https://github.com/RType/json#supported-compilers"
#endif
#endif
...
*/
    template<>
    inline void swap(RType::json& j1,
                     RType::json& j2) noexcept(
    is_nothrow_move_constructible<RType::json>::value and
    is_nothrow_move_assignable<RType::json>::value
    )
    {
        j1.swap(j2);
    }
...
/// hash value for JSON objects
    template<>
    struct hash<RType::json>
    {
        /*!
    @brief return a hash value for a JSON object
    @since version 1.0.0
    */
        std::size_t operator()(const RType::json& j) const
        {
            // a naive hashing via the string representation
            const auto& h = hash<RType::json::string_t>();
            return h(j.dump());
        }
    };
}
...
@since version 1.0.0
*/
inline RType::json operator "" _json(const char* s, std::size_t n)
{
    return RType::json::parse(s, s + n);
}
...
@since version 2.0.0
*/
inline RType::json::json_pointer operator "" _json_pointer(const char* s, std::size_t n)
{
    return RType::json::json_pointer(std::string(s, n));
}
